...
echo             ],>>"%launch_props%"
echo             "swoConfig":{>>"%launch_props%"
echo                 "enabled":true,>>"%launch_props%"
echo                 "source":"probe",>>"%launch_props%"
echo                 "swoFrequency": 2000000,>>"%launch_props%"
echo                 "cpuFrequency":170000000,>>"%launch_props%"
echo                 "decoders": [>>"%launch_props%"
echo                     {>>"%launch_props%"
echo                         "port": 0,>>"%launch_props%"
echo                         "type": "console",>>"%launch_props%"
echo                         "label": "SWO output">>"%launch_props%"
echo                     }>>"%launch_props%"
echo                 ]>>"%launch_props%"
echo             }>>"%launch_props%"
echo         }>>"%launch_props%"
